...
const MyApp = ({ Component, pageProps, router }) => {
  ...
  const isPsySomatic = '/professions/psihoterapiya/psihosomatika-i-telesnaya-psihoterapiya'
  const isShowTikTokAnalytics = router.asPath === isPsyCons || router.asPath ===  isPsySomatic
